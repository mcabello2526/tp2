...
class ChangeRegionsDialog extends JDialog implements EcoSysObserver {
	  ...
	  private void initGUI() {  
	    ...
	    JLabel text = new JLabel ("<html><p> Select a region type, the rows/cols interval, and provide values for the parameter in the, <b> Value column </b> (defaultdefault values</p><p> are used for parameters with no value).</p></html>"); 
