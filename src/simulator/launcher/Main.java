...
public class Main {
	...
	//
	public static Double time = null;
	...
	private static void startGUIMode() throws Exception {
		Simulator simulator = new Simulator(20, 15, 800, 600, animalsFactory, regionsFactory);
		if(deltaTime == null) deltaTime = 0.03;
		if(inFile != null){
		    InputStream is = new FileInputStream(new File(inFile));
			JSONObject json = loadJSONFile(is);
			is.close();
			...
			simulator = new Simulator(cols, rows, w, h, animalsFactory, regionsFactory);
