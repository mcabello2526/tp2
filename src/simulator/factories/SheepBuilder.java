...
public class SheepBuilder extends Builder<Animal> {
	...
	public SheepBuilder(Factory<SelectionStrategy> strategyFactory) {
		super("sheep", "Sheep animal factory");
		if (strategyFactory == null) {
			throw new IllegalArgumentException("The strategy factory cannot be null");
		}
	...
	protected Animal createInstance(JSONObject data) {
		// SelectFirstBuilder selectFirst = new SelectFirstBuilder();

		// SelectionStrategy mateStrategy = selectFirst.createInstance(data);
		SelectionStrategy mateStrategy = new SelectFirst();
		// SelectionStrategy dangerStrategy = selectFirst.createInstance(data);
		...
		if (data.has("danger_strategy")) {
			dangerStrategy = this.factory.createInstance(data.getJSONObject("danger_strategy"));
		}
